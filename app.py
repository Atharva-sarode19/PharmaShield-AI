...
from modules.quality_check import check_image_quality
...
if uploaded_file is not None:
    ...
    quality_result = check_image_quality(image_array)

    st.divider()
    st.header("📷 Image Quality Check")
    ...
    with q3:
        st.metric(
            "Brightness",
            f"{quality_result['brightness']:.1f}"
        )
    ...
    if quality_result["quality_ok"]:
        ...
        st.warning(
            "⚠️ Image quality may affect AI analysis."
        )
